    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollView1}>
          ...
          <View style={{marginTop:40, width: "100%", alignContent: "center", alignItems: "center" }}>
            <TouchableOpacity onPress={this.ReportSinister} style={{ justifyContent: "center", backgroundColor: "#5681FF", borderRadius: 15, height: 50, width: "80%" }}>
              <Text style={{ color: "white", fontSize: 17, fontWeight: "700", textAlign: "center" }}>Reportar ahora</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
